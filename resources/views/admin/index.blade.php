    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="w-100">
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-6 d-flex align-items-strech">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <span
                                                class="me-1 rounded-circle {{ $background }} round-20 d-flex align-items-center justify-content-center">
                                                <span class="ti {{ $icon . ' ' . $text }}"></span>
                                            </span>
                                            <p class="text-dark me-1 fs-3 mb-0">
                                                {{ number_format($merchants_percentage, 2) }} %</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <p class="text-dark me-1 fs-3 mb-0">
                                                {{ number_format($customers_percentage, 2) }} %</p>
                                            <p class="fs-3 mb-0">Today</p>
                                        </div>
                                    </div>
                                </div>
