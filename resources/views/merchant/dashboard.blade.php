    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            @if (\Auth::user()->is_restricted == 1)
                ...
                $account_restriction = \DB::table('restricted_merchants')
                ...
                <div class="align-items-center">
                    <div class="alert alert-danger text-center">
                        <span class="ti ti-lock-access-of"></span>
                        Your account has been restricted until
                        {{ \Carbon\Carbon::parse($account_restriction->end_date)->format('F d, Y') }}. Please contact
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <p class="text-dark me-1 fs-3 mb-0">
                                                    {{ number_format($percentageChange, 2) }}%</p>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span
                                                        class="fs-2">{{ count($months) >= 2 ? $months[count($months) - 2] : '' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                ...
                                <div class="card-body">
                                    <div class="row alig n-items-start">
                                        <div class="col-8">
                                            ...
                                            <h4 class="fw-semibold mb-3"><span
                                                    class="ti ti-currency-peso"></span>{{ $customer_payment_sum }}</h4>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card overflow-hidden rounded-2">
                            <div class="position-relative">
                                <a href="javascript:void(0)"><img style="width: 100%; height: 250px !important;"
                                        src="{{ asset($product->image) }}" class="card-img-top rounded-0 img-fluid"
                                        alt="..."></a>
                            </div>
                            <div class="card-body pt-3 p-4">
                                <h6 class="fw-semibold fs-4">{{ $product->name }}</h6>
                                <div class="d-flex align-items-center justify-content-between">
                                    <h6 class="fw-semibold fs-4 mb-0"><span class="ti ti-currency-peso"></span>
                                        {{ $product->price }} <span class="ms-2 fw-normal text-muted fs-3"><del><span
                                                    class="ti ti-currency-peso"></span>
                                                {{ $product->price + 59 }}</del></span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
