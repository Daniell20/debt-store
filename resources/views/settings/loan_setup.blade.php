            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        Loan Setup
                        <button class="float-end btn btn-primary btn-sm" id="createLoanSetupButton" data-bs-toggle="modal" data-bs-target="#loanSetupModal"><span class="ti ti-plus"></span> Create</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="col-lg-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="formData">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="interest_rate" name="interest_rate" placeholder="5%">
                                    <label for="interest-rate">Interest Rate (%)</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="months_to_pay" name="months_to_pay" placeholder="5 mos">
                ...
                <div class="modal-footer">
                    <button type="button" id="saveLoanSetupButton" class="btn btn-success loanSetupButton"><span class="ti ti-plus"></span> Save</button>
