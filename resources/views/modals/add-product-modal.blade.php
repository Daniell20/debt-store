    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4 px-2">
                        ...
                        <select name="store" id="store_id" class="form-select">
                            <option value="" hidden></option>
                            @foreach ($stores as $store)
                                <option class="form-select" value="{{ $store['store_id'] }}">{{ $store['store_name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group px-2 mb-4">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="submitProductModalButton">Submit</button>
